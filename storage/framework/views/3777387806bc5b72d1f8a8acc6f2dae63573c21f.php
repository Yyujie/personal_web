...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('/css/lrtk.css')); ?>">
    <script src="<?php echo e(URL::asset('/js/modernizr.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/js/jquery.imgbox.js')); ?>"></script>
</head>
<body>
<header>
...
<div class="template">
    <div class="box">
        ...
        <ul class="photo">
            <li><a  title="宇宙中心，关山大道" href="../images/work.jpg"><img alt="" src="<?php echo e(URL::asset('/images/work.jpg')); ?>" /></a><span>宇宙中心，关山大道</span></li>
            <li><a  title="学校后面的海滩" href="../images/college.jpg"><img alt="" src="<?php echo e(URL::asset('/images/college.jpg')); ?>" /></a><span>学校后面的海滩</span></li>
            <li><a  title="环绕家乡的骑行" href="../images/home.jpg"><img alt="" src="<?php echo e(URL::asset('/images/home.jpg')); ?>" /></a><span>环绕家乡的骑行</span></li>
            <li><a  title="灯光下的我们" href="../images/she.jpg"><img alt="" src="<?php echo e(URL::asset('/images/she.jpg')); ?>" /></a><span>灯光下的我们</span></li>
            <li><a  title="不会是离别" href="../images/way.jpg"><img alt="" src="<?php echo e(URL::asset('/images/way.jpg')); ?>" /></a><span>不会是离别</span></li>
            <li><a  title="这两只干嘛呀" href="../images/they.jpg"><img alt="" src="<?php echo e(URL::asset('/images/they.jpg')); ?>" /></a><span>这两只干嘛呀</span></li>
        </ul>
    </div>
</div>
<article>
    ...
    <div class="bloglist left">
        <h3>php是世界上最好的语言</h3>
        <figure><img src="<?php echo e(URL::asset('/images/001.jpg')); ?>"></figure>
        <ul>
        ...
        <h3>java是世界上最好的语言</h3>
        <figure><img src="<?php echo e(URL::asset('/images/002.jpg')); ?>"></figure>
        <ul>
        ...
        <p class="dateview"><span>2018-01-17</span><span>作者：带刀胖虎</span><span>个人博客：[<a href="#">不服就干</a>]</span></p>
        <h3>c#是世界上最好的语言</h3>
        <figure><img src="<?php echo e(URL::asset('/images/003.jpg')); ?>"></figure>
        <ul>
        ...
        <figure><img src="<?php echo e(URL::asset('/images/004.jpg')); ?>"></figure>
        <ul>
...
<script src="<?php echo e(URL::asset('/js/silder.js')); ?>"></script>
